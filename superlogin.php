...
if ( !isset($_SESSION['logged_in']) || !$_SESSION['logged_in'] || !isset($_SESSION['super_logged_in']) || !$_SESSION['super_logged_in'] ) {
    // User Not Logged In.
...
<html lang="en">
  ...
  <body class="text-center">
    <form class="form-signin" action="superlogin.php" method="POST">
      <img class="mb-4" src="images/logo.jpg" alt="" width="72" height="72">
      <h1 class="h3 mb-3 font-weight-normal">Presser Login</h1>
      <h3 class="h3 mb-3 font-weight-normal">(not for customers)</h3>
      ...
      <a class="btn btn-lg btn-primary btn-block" href="login.php" role="button">Customer Sign In</a>
